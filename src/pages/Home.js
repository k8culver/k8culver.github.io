...
function Home() {
    const words = [
        ...
        { text: 'AWS', value: 2, classes: 'text-white', description: '3 years professional' },
        ...
        { text: 'Git', value: 4, classes: 'text-white', description: '5 years professional' },
        ...
        { text: 'Elasticsearch', value: 2, classes: 'text-white', description: '2.5 years professional' },
        ...
        { text: 'Jest', value: 2, classes: 'text-white', description: '2 years professional' },
        ...
        { text: 'Agile', value: 4, classes: 'text-white', description: '5 years professional' },
        ...
        { text: 'Gatsby', value: 3, classes: 'text-white', description: '2.5 years professional' },
        ...
        { text: 'Figma', value: 3, classes: 'text-white', description: '2 years professional' },
        { text: 'Insomnia', value: 3, classes: 'text-white', description: '3 years professional' },
      ];
